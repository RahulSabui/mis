                            ...
                            <div class="card-body p-sm-5">
                                <div class="p-3">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button type="button" class="btn btn-primary abc">Send</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".abc").click(function(e) {
                ...
                // Display the toastr.info message
                // toastr.info('The mail has been sent', 'Info');

                // Redirect to the signup page after a delay (e.g., 2 seconds)
                // setTimeout(function() {
                    window.location.href =
                    '/signup'; // Replace '/signup' with the actual URL of your signup page
