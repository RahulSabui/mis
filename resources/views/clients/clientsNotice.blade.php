@extends('layouts.app')
@section('title', 'Clients under Notice')
@section('content')
                        ...
                        <div class="ps-sm-1">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Clients Under Notice
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="card radius-10 btn-inverse-purple w-100">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <p class="mb-0 text-secondary">Clients Under Notice</p>
                                                <h4 class="my-1">62</h4>
                                            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="d-flex justify-content-between">
                                <h5 class="card-title">List of Client Under Notice</h5>
                                <div class="ms-auto d-flex align-items-center">
    ...
    <div class="switcher-wrapper">
        ...
        <div class="switcher-body">
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <label for="input2" class="form-label">Period</label>
