			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						...
						<li> <a href="./activeProcesses"><i class='bx bx-radio-circle text-orange'></i>Processes</a>
						</li>
						...
						<div class="ps-sm-1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									...
									<li class="breadcrumb-item active" aria-current="page">Clients Report
									</li>
								</ol>
							</nav>
						</div>
				...
				<div class="row">
					<div class="col-lg-8 d-flex">
						<div class="card w-100">
							<div class="card-body">
								<p class="mb-3 text-secondary">Active Clients by Type of Business</p>
								<div class="chart-container1">
									<canvas id="activeClientsByBusiness"></canvas>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							<div class="d-flex justify-content-between">
								<h5 class="card-title">Active Client List</h5>
								<div class="ms-auto d-flex align-items-center">
									<div class="position-relative">
							...
							<table class="table align-middle mb-0 table-striped">
								<thead class="table-light">
									<tr>
										...
										<th>Operations Point of Contact</th>
										<th>
