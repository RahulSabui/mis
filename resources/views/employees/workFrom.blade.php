						...
						<div class="ps-sm-1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									...
									<li class="breadcrumb-item active" aria-current="page">WFO/WFH Report
									</li>
								</ol>
							</nav>
						</div>
								...
								<div class="card radius-10 btn-inverse-info w-100">
									<div class="card-body">
										<div class="d-flex align-items-center">
											<div>
												<p class="mb-0 text-secondary">Employees Working From Home</p>
												<h4 class="my-1">62</h4>
											</div>
							...
							<div class="col-md-6 col-lg-4 col-xl-3">
								<div class="card radius-10 btn-inverse-danger  w-100">
									<div class="card-body">
										<div class="d-flex align-items-center">
											<div>
												<p class="mb-0 text-secondary">Employees Working From Office</p>
												<h4 class="my-1">55</h4>
											</div>
								...
								<tbody>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="">
													<img src="assets/images/avatars/avatar-6.png" class="rounded-circle" width="46" height="46"
														alt="" />
												</div>
												<div class="ms-2">
													<h6 class="mb-1 font-14">Payment from Michle Jhon</h6>
