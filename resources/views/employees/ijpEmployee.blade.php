@extends('layouts.app')
@section('title', 'Internal Job Promotions Report ')
@section('content')
						...
						<div class="ps-sm-1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									...
									<li class="breadcrumb-item active" aria-current="page">Internal Job Promotions
										Report
								...
								<div class="card radius-10 btn-inverse-info w-100">
									<div class="card-body">
										<div class="d-flex align-items-center">
											<div>
												<p class="mb-0 text-secondary">Applied Employees</p>
												<h4 class="my-1">62</h4>
											</div>
							...
							<div class="col-md-6 col-lg-4 col-xl-3">
								<div class="card radius-10 btn-inverse-danger  w-100">
									<div class="card-body">
										<div class="d-flex align-items-center">
											<div>
												<p class="mb-0 text-secondary">Promoted Employees</p>
												<h4 class="my-1">55</h4>
											</div>
